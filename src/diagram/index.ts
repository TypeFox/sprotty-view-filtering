...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // reset the filter UI
    const resetFilterUI = () => {
        el('titleFilter')!.innerText = '';
        el('authorFilter')!.innerText = '';
        el('yearFilter')!.innerText = '';
        (el('fieldsOfStudyFilter') as HTMLInputElement)!.value = 'all';
    }
    ...
    el('showAll')!.addEventListener('click', async () => {
        ...
        resetFilterUI();
        additionalChildLevelsFilter.value = '0';
        additionalChildLevel!.innerText = '0';
        additionalParentLevelsFilter.value = '0';
        additionalParentLevel!.innerText = '0';
        modelSource.handle({
            kind: FilterAction.KIND,
            filter
        } as FilterAction);
